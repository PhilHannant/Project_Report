...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.15]{RW200}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{images/Scope.jpg}
  \caption{Screenshot of the SCOPE system}
  \label{fig: scope}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{images/coach.jpg}
  \caption{A subfigure}
  \label{fig: coach}
\end{subfigure}
...
\begin{Figure}
	\centering
	\includegraphics[scale=0.5]{images/staff.jpg}
