...
The actor system employed within the RTT\_Analyser is constructed of five different actors in total and a sealed trait (Figure~\ref{fig: messages}) containing case classes representing the messages permitted to be passed between the actors.\par
